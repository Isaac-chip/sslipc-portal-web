...
import { getPicture, reqCheck } from "../../api/index";
      ...
      <div className='verifybox' style={{ maxWidth: parseInt(imgSize.width) + 30 + 'px' }}>
        ...
        <div className='verifybox-bottom' style={{padding:'15px'}}>
          ...
          <div style={{ position: 'relative' }}>
            ...
            <img src={'data:image/png;base64,' + this.state.pointBackImgBase} alt="" style={{width:'100%',height:'100%',display:'block'}} onClick={($event) => this.canvasClick($event)}/>:<img src={"../../../assets/images/default.jpg"} alt="" style={{width:'100%',height:'100%',display:'block'}}/>}
...
VerifyPointFixed.defaultProps = {
  ...
  closeFn: () => {
    // Default implementation for closeFn
  }
};
